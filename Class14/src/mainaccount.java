...
public class mainaccount {
	public static void main(String[] args) {
		...
		accountnumber.printBalance();
		accountnumber.deposit(5000);
		accountnumber.withdraw(10000);
	}
}
...
//protected → 동일 패키지 내에서 모두 접근 가능, 외부 패키지에서는 상속을 받은 클래스 내부에서만 접근 가능
...
//게터와 세터를 통해 정보은닉을 유지하고, 외부에서도 필요한 데이터에 접근을 가능하게 한다.